...
public class DetailedTripViewPageController implements Initializable {
    ...
    public void initData(Event event){
        ...
        startDateLabel.setText(event.getEventDate().toString());
        ...
        agencyLabel.setText(event.getTravelAgencyName());
