...
public class ClientVIAConsole implements VIAView, Runnable{

    private Scanner input;
    private ClientVIAController controller;

    public ClientVIAConsole()
    {
        input = new Scanner(System.in);
        controller = null;
    }

    public void startView(ClientVIAController controller)
    {
